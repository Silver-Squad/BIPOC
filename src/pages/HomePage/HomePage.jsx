...
export default function Signup (props) {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      <div>
      <h2 className="mt-6 text-3xl font-extrabold text-gray-900 flex items-center justify-center">Diversity found easily</h2>
      <h2 className="mt-6 text-1xl font-extrabold text-gray-900 flex items-center justify-center">Search for a company's D&I score here...</h2>
        <div class="p-8">
          <div class="bg-white flex items-center rounded-full shadow-xl">
            <input class="rounded-l-full w-full py-4 px-6 text-gray-700 leading-tight focus:outline-none" id="search" type="text" placeholder="🔍   company name">
            </input>

            <div class="p-4">
              <button class="bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none flex items-center justify-center">
                Search
              </button>
            </div>
            </div>
